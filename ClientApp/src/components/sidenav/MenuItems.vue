<template>
  <ul class="my-1.5 text-normalColor">
    ...
    >
      ...
      <span class="pt-3">Playlists</span>
    </router-link>
    ...
    >
      ...
      <span class="pt-1 overflow-hidden">Create Playlist</span>
    </button>
    ...
    >
      ...
      <span class="pt-1">Favorites</span>
    </router-link>
...
export default {
  ...
  methods: {
    createPlaylist() {
      this.$store.dispatch("pages/playlist/createPlaylist", null, {
        root: true,
      });
    },
  },
