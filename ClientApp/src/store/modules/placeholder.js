  ...
  actions: {
    getPlaceholderFeaturedPlaylists({ commit }) {
      return new Promise((resolve, reject) => {
        ...
        axios.get('https://api.spotify.com/v1/browse/featured-playlists?country=US&limit=20')
          .then((res) => {
    ...
    getPlaceholderPlaylists({ commit }) {
      return new Promise((resolve, reject) => {
        ...
        axios.get('https://api.spotify.com/v1/browse/featured-playlists?country=US&locale=US&timestamp=2021-10-18T09%3A00%3A00.000Z&limit=10&offset=0')
          .then((res) => {
