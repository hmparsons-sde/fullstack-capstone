<template>
  ...
  >
    ...
    <div class="text-2xl font-bold tracking-tighter">Add to queue</div>

      <div class="opacity-60 font-bold pt-3">Currently playing</div>
      ...
      <table class="w-full pt-2">
        ...
        <tbody v-else class="text-center"> Nothing playing. </tbody>
      ...
      <div class="pt-10 font-bold ">
        ...
        <tbody v-else class="text-center"> Nothing queued. </tbody>
